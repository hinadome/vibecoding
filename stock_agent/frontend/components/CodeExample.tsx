 ...
 */
/**
 * Purpose: Describe what `parseMarkdown` does within the frontend flow.
 * Args/Params:
 * - md: Value consumed by `parseMarkdown`.
 * Returns:
 ...
 */
/**
 * Purpose: Describe what `renderLineWithInlineCode` does within the frontend flow.
 * Args/Params:
 * - line: Value consumed by `renderLineWithInlineCode`.
 * Returns:
 * - Varies by usage (UI element, transformed payload, or helper value).
 * Raises/Exceptions:
 * - Propagates runtime errors when invalid input/state is provided.
 ...
 */
/**
 * Purpose: Render code sample panel with optional link-out and clipboard copy.
 * Args/Params:
 * - code: Optional markdown/code content override.
 * - href: Optional external link for opening full document.
 * - compact: Whether compact spacing variant is used.
 * - heightClass: Optional class controlling panel height.
 * - centerVertically: Whether copy button is vertically centered.
 * Returns:
 * - React.ReactNode containing styled example code UI.
 * Raises/Exceptions:
 * - Clipboard/browser errors are caught in `copyToClipboard`; render errors propagate.
 * Examples:
 * - `CodeExample({ code: "# AGENTS.md", compact: true })`
 */
export default function CodeExample({
  ...
  /**
   * Purpose: Describe what `copyToClipboard` does within the frontend flow.
   * Args/Params:
   * - None.
   * Returns:
   * - Varies by usage (UI element, transformed payload, or helper value).
