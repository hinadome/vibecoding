...
/**
 * Purpose: Render one repository card with metadata and contributor avatars.
 * Args/Params:
 * - repo: Repository metadata to display.
 * - avatars: Optional avatar URLs for top contributors.
 * - totalContributors: Total contributor count shown in badge.
 * - hideOnSmall: Whether to hide card on small viewports.
 * - hideOnMedium: Whether to hide card on medium viewports.
 * Returns:
 * - React.ReactNode anchor card linked to AGENTS.md path in repository.
 * Raises/Exceptions:
 * - None directly; invalid URLs/images may fail at browser load time.
 * Examples:
 * - `ExampleCard({ repo, avatars, totalContributors: 12 })`
 */
